...
public interface GameRelationRepository extends CrudRepository<GameRelation, Long> {
	...
	public GameRelation findGameRelationForUser (String username);
        ...
        @Query("MATCH (u:User)-[r:GAME_RELATION]->(c:Game) WHERE u.username = {0} and ID(c) = {1} RETURN r")
	public GameRelation findGameRelationForUser (String username, Long gameId);
